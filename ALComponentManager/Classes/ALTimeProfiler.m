...
@implementation ALTimeProfiler

+ (ALTimeProfiler *)sharedTimeProfiler
{
    static dispatch_once_t onceToken;
    static ALTimeProfiler *profiler = nil;
    dispatch_once(&onceToken, ^{
        profiler = [[ALTimeProfiler alloc] initTimeProfilerWithMainKey:@""];
    });
    return profiler;
}
...
- (void)saveTimeProfileDataIntoFile:(NSString *)fileName
{
    ...
    NSLog(@"ALTimeProfiler::SaveFilePath is %@", filePath);
