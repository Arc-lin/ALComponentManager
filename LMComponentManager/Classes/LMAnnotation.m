...
{
    NSArray *mods = LMReadConfiguration(LMModSectName, mhp);
...
//    //register services
//    NSArray<NSString *> *services = LMReadConfiguration(LMServiceSectName,mhp);
...
//
//                if (protocol && clsName) {
//                    [[LMComponentManager sharedManager] registerService:NSProtocolFromString(protocol) implClass:NSClassFromString(clsName)];
//                }
//
//            }
//        }
